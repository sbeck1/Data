...
dat<- read_csv("as_built_all_20180930.csv")

dat$Date=mdy("09/30/2018") #need to add the sampling/delivery date
...
dat4<-dat3%>%
  mutate(Element_id_2=fct_relevel(Element_id_2,"2","3","4","5","6",
                                  "8B","9A","9B","10A","10B","11A","11B",
                                  "12","13","14","15","16","18"))
